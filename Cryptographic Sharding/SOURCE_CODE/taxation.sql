...
-- Dumping database structure for taxation
CREATE DATABASE IF NOT EXISTS `taxation` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `taxation`;

-- Dumping structure for table taxation.blockchain
...
-- Dumping data for table taxation.blockchain: ~6 rows (approximately)
...
-- Dumping structure for table taxation.chalan
...
-- Dumping data for table taxation.chalan: ~0 rows (approximately)
/*!40000 ALTER TABLE `chalan` DISABLE KEYS */;
/*!40000 ALTER TABLE `chalan` ENABLE KEYS */;

-- Dumping structure for table taxation.payslip
...
-- Dumping data for table taxation.payslip: ~1 rows (approximately)
...
-- Dumping structure for table taxation.pfreq
...
-- Dumping data for table taxation.pfreq: ~1 rows (approximately)
...
-- Dumping structure for table taxation.useraccounts
...
-- Dumping data for table taxation.useraccounts: ~0 rows (approximately)
/*!40000 ALTER TABLE `useraccounts` DISABLE KEYS */;
/*!40000 ALTER TABLE `useraccounts` ENABLE KEYS */;

-- Dumping structure for table taxation.users
...
-- Dumping data for table taxation.users: ~1 rows (approximately)
