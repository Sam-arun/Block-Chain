...
<!-- //banner -->
	...
	<div class="services" id="services">
		<div class="container">
			<h2 class="w3ls_head"><span></span>Admin 2 Dashboard</h2>
<!-- 			<p class="w3agile">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque
		...
		<div class="hei">
			<c:if test="${param.st eq 'pf1'}">
						<p class="success"><img src="images/success.png" width="30" height="30">PF processing status sent Successfully</p>
						</c:if>
		</div>
