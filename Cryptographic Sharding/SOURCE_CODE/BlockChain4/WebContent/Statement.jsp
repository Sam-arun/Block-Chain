...
<!-- //banner -->
	...
	<div class="services" id="services">
		<div class="container">
			<h2 class="w3ls_head"><span>Upload </span>Statement</h2>
		</div></div>
		<div class="hei">
			<c:if test="${param.st eq 'snot'}">
						<p class="error"><img src="images/error.png" width="30" height="30">Statements Not Applied</p>
						</c:if>
		<form action="Upload" method="post" enctype="multipart/form-data">
		<input type="hidden" value="Submitted" name="sta">
		<table id="customers" align="center">
			<tr>
				<th>INSURANCE STATEMENT :</th><td><input type="file" name="in" id="in" value="Not Submitted" required></td>
			</tr>
			<tr>
				<th>RENTAL STATEMENT :</th><td><input type="file" name="re" Placeholder="RS./-" id="re" value="Not Submitted" required></td>
			</tr>
			<tr>
				<th>LOAN STATEMENT :</th><td><input type="file" name="lo" Placeholder="RS./-" id="ln" value="Not Submitted" required></td>
			</tr>
		</table>
