...
<!-- //banner -->
	...
	<div class="services" id="services">
		<div class="container">
			<h2 class="w3ls_head"><span>Employee</span>Dashboard</h2>
		</div></div>
		
		<div class="hei">
		<c:if test="${param.st eq 'ded'}">
						<p class="success"><img src="images/success.png" width="30" height="30"> Deductions Applied Successfully</p>
						</c:if>
			<c:if test="${param.st eq 'syes'}">
						<p class="success"><img src="images/success.png" width="30" height="30"> Deduction Statements Applied Successfully</p>
						</c:if>
			<c:if test="${param.st eq 'pf'}">
						<p class="success"><img src="images/success.png" width="30" height="30"> PF request Submitted Successfully</p>
						</c:if>
