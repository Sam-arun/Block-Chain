...
<html lang="en">
<head>
<title>Admin Statement Check</title>
<!-- custom-theme -->
...
<!-- //banner -->
	...
	<div class="services" id="services">
		<div class="container">
			<h2 class="w3ls_head"><span>Statements submission </span>List</h2>
		</div></div>
		<div class="hei">
		<table id="customers">
       <thead>  
		...
		<tbody>
					<tr>
						...
						<td><%=r.getString("Pstatus")%></td>
						<td><a href="ViewStatement.jsp?uid=<%=r.getString("userid")%>">View</a></td>
					</tr>
