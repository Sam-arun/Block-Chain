	...
	<center><h3 style="color:white;">INCOME</h3></center>
		<div class="w3l-last-grid1">
			<div class="w3l-grid1">
				...
				<div class="w3l-div">
					<input type="text" name="i1" id="i1" placeholder="Rs./-" required="" onkeyup="income();" onkeypress='validate(event)'/>
				</div>
			</div> 
			<div class="w3l-grid2">
			<label class="text">Annual Income from other Sources</label>
			<div class="w3l-div">
				<input type="text" name="i2" placeholder="Rs./-" value="0" required="" onkeypress='validate(event)'/>
			</div>
			</div>
			<div class="clear"></div>
		</div>	
		...
		<div class="w3l-last-grid1">
			<div class="w3l-grid1">
				...
				<div class="w3l-div">
					<input type="text" name="i3" placeholder="Rs./-" required=""/ value="0" onkeypress='validate(event)'>
				</div>
			</div> 
			<div class="w3l-grid2">
			<label class="text">Annual Income from Interest</label>
			<div class="w3l-div">
				<input type="text" name="i4" placeholder="Rs./-" required="" value="0"/ onkeypress='validate(event)'>
			</div>
			</div>
			<div class="clear"></div>
		</div>	
...
<center><h3 style="color:white;">DEDUCTIONS</h3></center>
		<div class="w3l-last-grid1">
			<div class="w3l-grid1">
				...
				<div class="w3l-div">
					<input type="text" name="d1" placeholder="Rs./-" required="" onkeypress='validate(event)'/>
				</div>
			</div> 
			<div class="w3l-grid2">
			<label class="text">Donation to Charity u/s 80G</label>
			<div class="w3l-div">
				<input type="text" name="d2" placeholder="Rs./-" required="" value="0" onkeypress='validate(event)'/>
			</div>
			</div>
			<div class="clear"></div>
		</div>	
		...
		<div class="w3l-last-grid1">
			<div class="w3l-grid1">
				...
				<div class="w3l-div">
					<input type="text" name="d3" placeholder="Rs./-" required="" value="0" onkeypress='validate(event)'/>
				</div>
			</div> 
			<div class="w3l-grid2">
			<label class="text">Interest on Loan u/s 80E</label>
			<div class="w3l-div">
				<input type="text" name="d4" placeholder="Rs./-" required="" value="0" onkeypress='validate(event)'/>
			</div>
			</div>
			<div class="clear"></div>
		</div>	
		<div class="w3l-last-grid1">
			<div class="w3l-grid1">
				...
				<div class="w3l-div">
					<input type="text" name="t3" placeholder="Rs./-" required="" value="0" onkeypress='validate(event)'/>
				</div>
			</div> 
			<div class="clear"></div>
		</div>	
