...
<!-- //banner -->
	...
	<div class="services" id="services">
		<div class="container">
			<h2 class="w3ls_head"><span>Statement </span>Proofs</h2>
		</div></div>
       ...
       <thead>  
		...
		<tbody>
					<tr>
						<td><%out.print(k);%></td>
						<td><textarea rows="5" cols="15"><%=r.getString("p1")%></textarea></td>
						<td><textarea rows="5" cols="15"><%=r.getString("p2")%></textarea></td>
						<td><textarea rows="5" cols="15"><%=r.getString("p3")%></textarea></td>
						<td><a href="Report_email.jsp?user=<%=r.getString("userid")%>">Send Status</a></td>
					</tr>
